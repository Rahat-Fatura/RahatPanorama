...
TemplateCustomizer.LANGUAGES.tr = {
    panel_header: "KİŞİSELLEŞTİRME",
    panel_sub_header: "Temayı bu panelden güncelleyebilirsiniz.",
    theming_header: "TEMA",
    theme_header: "TEMA",
    theme_label: "TEMALAR",
    style_label: "Stil (Mod)",
    style_switch_light: "Aydınlık",
    style_switch_dark: "Karanlık",
...
TemplateCustomizer.THEMES = [
    {
        name: "theme-default-connect",
        title: "Varsayılan",
    },
    {
        name: "theme-connect-semi-dark",
        title: "Yarım",
    },
    {
        name: "theme-connect-bordered",
        title: "Kenarlıklı",
    },
];
