            ...
            const fv = FormValidation.formValidation(twoStepsForm, {
                fields: {
                    otp_value: {
                        validators: {
                            notEmpty: {
                                message: "6 haneli kodunuzu giriniz",
                            },
                        },
                    },
                },
            ...
            const keyupHandler = function () {
                ...
                numeralMaskList.forEach((numeralMaskEl) => {
                    if (numeralMaskEl.value === "") {
                        otpFlag = false;
                        twoStepsForm.querySelector('[name="otp_value"]').value = "";
                    }
                    otpVal = otpVal + numeralMaskEl.value;
                });
                if (otpFlag) {
                    twoStepsForm.querySelector('[name="otp_value"]').value = otpVal;
                    // alert("Kodunuz doğrulandı " + otpVal);
                }
            };
